...
* set the variable `barr` to Dr Barr's first name in all lowercase letters
* set the variable `BARR` to Dr Barr's first name in all uppercase letters
...
* `infmort`: load data in the CSV file "https://gupsych.github.io/data_skills/data/infmort.csv" using the URL
* `matmort`: download the excel file [matmort.xls](https://gupsych.github.io/data_skills/data/matmort.xls) into the same folder as this file and load the local file using a function from the package `readxl`

```{r loading-data, echo = TRUE}
infmort <- read_csv("https://gupsych.github.io/data_skills/data/infmort.csv")
matmort <- read_xls("matmort.xls")
```
...
infmort2 <- readr::read_csv("https://gupsych.github.io/data_skills/data/infmort.csv")
matmort2 <- read_xls("matmort.xls")
```

* `infmort`: `r check(all_equal(infmort, infmort2))`
* `matmort`: `r check(all_equal(matmort, matmort2))`

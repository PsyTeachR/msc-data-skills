...
3. Arrange plots in a grid using [`cowplot`](#cowplot)
4. Set custom [labels](#custom-labels),  [colours](#custom-colours), and [themes](#themes)
5. Represent factorial designs with different colours or facets
6. [Save plots](#ggsave) as an image file
7. Superimpose different types of graphs
    
### Intermediate

8. Add lines to graphs
9. Deal with [overlapping data](#overlap)
10. Create less common types of graphs
    + [`geom_tile()`](#geom_tile)
...
<a class='glossary' target='_blank' title='Data that can take on any values between other existing values.' href='https://psyteachr.github.io/glossary/c#continuous'>Continuous</a> variables are properties you can measure, like height. <a class='glossary' target='_blank' title='Data that can only take certain values, such as integers.' href='https://psyteachr.github.io/glossary/d#discrete'>Discrete</a> variables are things you can count, like the number of pets you have. Categorical variables can be <a class='glossary' target='_blank' title='NA' href='https://psyteachr.github.io/glossary/n#nominal'>nominal</a>, where the categories don't really have an order, like cats, dogs and ferrets (even though ferrets are obviously best). They can also be <a class='glossary' target='_blank' title='NA' href='https://psyteachr.github.io/glossary/o#ordinal'>ordinal</a>, where there is a clear order, but the distance between the categories isn't something you could exactly equate, like points on a <a class='glossary' target='_blank' title='NA' href='https://psyteachr.github.io/glossary/l#likert'>Likert</a> rating scale.
...
`ggplot2` creates plots using a "grammar of graphics" where you add <a class='glossary' target='_blank' title='NA' href='https://psyteachr.github.io/glossary/g#geoms'>geoms</a> in layers. It can be complex to understand, but it's very powerful once you have a mental model of how it works. 
...
<div class="figure" style="text-align: center">
<img src="03-ggplot_files/figure-html/ggplot_empty-1.png" alt="A plot base created by ggplot()" width="100%" />
<p class="caption">(\#fig:ggplot_empty)A plot base created by ggplot()</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="03-ggplot_files/figure-html/ggplot_labels-1.png" alt="Empty ggplot with x and y labels" width="100%" />
<p class="caption">(\#fig:ggplot_labels)Empty ggplot with x and y labels</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="03-ggplot_files/figure-html/ggplot_geom-1.png" alt="Violin plot with country represented by colour." width="100%" />
<p class="caption">(\#fig:ggplot_geom)Violin plot with country represented by colour.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="03-ggplot_files/figure-html/colplot_statsum-1.png" alt="Column plot" width="100%" />
<p class="caption">(\#fig:colplot_statsum)Column plot</p>
</div>
...
cb <- gg + geom_crossbar()
eb <- gg + geom_errorbar()
lr <- gg + geom_linerange()
pr <- gg + geom_pointrange()
labels <- c("geom_crossbar()", 
            "geom_errorbar()", 
            "geom_linerange()", 
            "geom_pointrange()")

plot_grid(cb, eb, lr, pr, labels = labels)
```

<div class="figure" style="text-align: center">
<img src="03-ggplot_files/figure-html/vertint-1.png" alt="Different vertical interval geoms" width="100%" />
<p class="caption">(\#fig:vertint)Different vertical interval geoms</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="03-ggplot_files/figure-html/vertint_statssum-1.png" alt="Vertical intervals with stats_summary()" width="100%" />
<p class="caption">(\#fig:vertint_statssum)Vertical intervals with stats_summary()</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="03-ggplot_files/figure-html/custom_themes-1.png" alt="Custom theme" width="100%" />
<p class="caption">(\#fig:custom_themes)Custom theme</p>
</div>
...
|<a class='glossary' target='_blank' href='https://psyteachr.github.io/glossary/g#geoms'>geoms</a>           |NA                                                              |
|<a class='glossary' target='_blank' href='https://psyteachr.github.io/glossary/l#likert'>likert</a>         |NA                                                              |
|<a class='glossary' target='_blank' href='https://psyteachr.github.io/glossary/n#nominal'>nominal</a>       |NA                                                              |
|<a class='glossary' target='_blank' href='https://psyteachr.github.io/glossary/o#ordinal'>ordinal</a>       |NA                                                              |

...
## Observations: 249
## Variables: 11
## $ name                       <chr> "Afghanistan", "Åland Islands", "Al...
## $ `alpha-2`                  <chr> "AF", "AX", "AL", "DZ", "AS", "AD",...
## $ `alpha-3`                  <chr> "AFG", "ALA", "ALB", "DZA", "ASM", ...
## $ `country-code`             <chr> "004", "248", "008", "012", "016", ...
## $ `iso_3166-2`               <chr> "ISO 3166-2:AF", "ISO 3166-2:AX", "...
## $ region                     <chr> "Asia", "Europe", "Europe", "Africa...
## $ `sub-region`               <chr> "Southern Asia", "Northern Europe",...
## $ `intermediate-region`      <chr> NA, NA, NA, NA, NA, NA, "Middle Afr...
## $ `region-code`              <chr> "142", "150", "150", "002", "009", ...
## $ `sub-region-code`          <chr> "034", "154", "039", "015", "061", ...
...
## $ Year    <dbl> 2015, 2014, 2013, 2012, 2011, 2010, 2009, 2008, 2007, ...
...
13. Using the family composition dataset from question 11, calculate how many siblings of each sex each person has, narrow the dataset down to people with fewer than 6 siblings, and generate at least two different ways to graph this.
    ...
    <img src="04-tidyr_files/figure-html/exercise-sibs1-1.png" width="672" />
    ...
    <img src="04-tidyr_files/figure-html/exercise-sibs2-1.png" width="672" />
    </div>

...
In the next two lectures, we are going to learn more about `r glossary("iteration")` (doing the same commands over and over) and `r glossary("custom functions")` through a data simulation exercise, which will also lead us into more traditional statistical topics.
